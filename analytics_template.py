...
credentials = service_account.Credentials.from_service_account_file(
    "SERVICE_ACCOUNT_KEY_JSON") # add service account key file here
credentials = credentials.with_scopes(['https://www.googleapis.com/auth/analytics.readonly'])

analytics = build('analyticsreporting', 'v4', credentials=credentials)
VIEW_ID='VIEW_ID' # view id you want to pull from your google analytics account
...
class report:
    ...
    def get_report(report_build): # pull the report based on the report build
